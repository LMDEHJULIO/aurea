    ...
    <Fragment>
      <section className="product-display">
        <div className="product-display__grid">
          <img
            src={product.image}
            className="product-display-img product-display-img--1"
          />
          <img
            src={product.image}
            className="product-display-img product-display-img--2"
          />
          <img
            src={product.image}
            className="product-display-img product-display-img--3"
          />
          <img
            src={product.image}
            className="product-display-img product-display-img--4"
          />
        </div>
        ...
        <div className="product-display__details">
          ...
          <div className="product-display__cta">
            ...
            <p className="product-cta-subheading">
            ...
            <div>
              <form className="form--add-to-cart">
                <input
                  ...
                  className="form--add-to-cart__input"
                />
